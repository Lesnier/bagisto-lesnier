            ...
            methods: {
                ...
                getLabel(item) {
                    ...
                    if (item.translations && item.translations.length > 0) {
                        let translation = item.translations.find((t) => t.locale === this.fallbackLocale);
                        if (translation && translation[this.labelField]) {
                            return translation[this.labelField];
                        }
                        return item.translations[0][this.labelField] || 'Unnamed Category';
                    }

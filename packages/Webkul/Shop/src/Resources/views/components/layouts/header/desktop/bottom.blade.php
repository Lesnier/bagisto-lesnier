        ...
        <div class="hidden lg:flex items-center ml-4">
            @auth('customer')
                @if(! auth()->guard('customer')->user()->is_vendor())
                    <a href="{{ route('marketplace.vendor.apply.create') }}" class="px-4 py-2 text-sm font-semibold text-white bg-navyBlue rounded-lg hover:bg-navyBlue-800 transition-all">
                        Convertirme en Vendor
                    </a>
                @endif
            @endauth
            @guest('customer')
                <a href="{{ route('shop.customer.session.create') }}" class="px-4 py-2 text-sm font-semibold text-white bg-navyBlue rounded-lg hover:bg-navyBlue-800 transition-all">
                    Convertirme en Vendor
                </a>
            @endguest
        </div>
                ...
                @auth('customer')
                    <x-slot:content class="!p-0">
                        ...
                        <div class="mt-2.5 grid gap-1 pb-2.5">
                            ...
                            @if(auth()->guard('customer')->user()->is_vendor())
                                <a
                                    class="px-5 py-2 text-base cursor-pointer hover:bg-gray-100 font-semibold text-indigo-700"
                                    href="{{ route('marketplace.vendor.profile', ['slug' => auth()->guard('customer')->user()->vendor->shop_slug]) }}"
                                >
                                    Mi Tienda
                                </a>
                                <a
                                    class="px-5 py-2 text-base cursor-pointer hover:bg-gray-100 font-semibold text-blue-700"
                            ...
                            @else
                                <a
                                    class="px-5 py-2 text-base cursor-pointer hover:bg-gray-100 font-medium"

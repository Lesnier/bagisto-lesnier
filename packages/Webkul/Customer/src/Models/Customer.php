...
class Customer extends Authenticatable implements CustomerContract
{
    ...
    /**
     * Get the vendor profile associated with the customer.
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function vendor()
    {
        return $this->hasOne(\Webkul\Marketplace\Models\VendorProxy::modelClass(), 'customer_id');
    }

    /**
     * Check if the customer is an approved vendor.
     *
     * @return bool
     */
